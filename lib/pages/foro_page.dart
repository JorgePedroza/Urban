  ...
  Widget build(BuildContext context) {
    var questionSection = new Padding(
      ...
      child: new Column(
        children: <Widget>[
          new Text(
            "Cuenta tu experiencia en UrbanBus",
            textScaleFactor: 1.5,
          ...
          new Padding(
            ...
            child: new Row(
              ...
              children: <Widget>[
                new IconWithText(Icons.sync_problem, "Reporta algun \n problema", iconColor: Colors.red,),
                
               
                new IconWithText(Icons.add_box, "Agregar \n comentario",iconColor: Colors.blueGrey,),
